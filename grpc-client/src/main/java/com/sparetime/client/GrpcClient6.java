...
public class GrpcClient6 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            StreamObserver<HelloProto.HelloRequest> requestObserver = helloService.biDirectionStream(new StreamObserver<>() {
                @Override
                public void onNext(HelloProto.HelloResponse response) {
                    System.out.println("收到服务端回的消息：" + response.getResult());
                }
